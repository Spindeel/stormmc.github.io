...
function openContent5() {
    var show1 = document.getElementById('content5');
    var but1 = document.getElementById('button5');
    if (!show1.style.display || show1.style.display == 'none') {
        show1.style.display = 'block';
        but1.value = '-';
    } else {
...
function openContent6() {
    var show1 = document.getElementById('content6');
    var but1 = document.getElementById('button6');
    if (!show1.style.display || show1.style.display == 'none') {
        show1.style.display = 'block';
        but1.value = '-';
    } else {
